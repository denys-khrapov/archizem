...
function wpbase_styles_scripts()
{
	...
	wp_enqueue_style('styles', get_stylesheet_uri(), array('font-awesome', 'swiper', 'fancybox'), '');
	...
	// Swiper
	wp_register_style('swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css', array(), '');
	wp_register_script('swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array(), '', true);


	wp_enqueue_script('scripts', get_template_directory_uri() . '/js/main.js', array('jquery', 'swiper', 'fancybox'), '', true);
}
